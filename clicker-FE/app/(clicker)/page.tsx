...
const Clicker = () => {
  return (
    <div className="container-xl  flex overflow-hidden justify-center items-center h-screen bg-[#161616] text-white flex-col">
      <div
        id="snow-box"
      ...
      <button
        className="bg-[#3b3b3b] relative  w-[30%] mt-1 p-2 text-[22px] rounded-t-sm rounded-b-xl"
        onClick={onSubmit}
      >
        +1
      </button>
